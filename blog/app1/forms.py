...
class FormularioNuevoPrenda(forms.ModelForm):
    class Meta:
        model = Prenda
        fields = ('usuario', 'titulo', 'tipo', 'marca', 'modelo', 'descripcion', 'year', 'precio', 'telefonoContacto', 'emailContacto', 'imagenPrenda')
...
class ActualizacionPrenda(forms.ModelForm):
    class Meta:
        model = Prenda
        fields = ('titulo', 'tipo', 'marca', 'modelo', 'descripcion', 'year', 'precio', 'telefonoContacto', 'emailContacto', 'imagenPrenda')
